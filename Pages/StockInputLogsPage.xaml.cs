...
/// <summary>
/// Interaction logic for StockInputLogsPage.xaml
/// </summary>
public partial class StockInputLogsPage : Page
{
    public StockInputLogsPage() => InitializeComponent();
    ...
    private void Page_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        Dispatcher.BeginInvoke(
            ...
            new Action(() =>
            {
                ...
                {
                    var minMax = dbContext.StockInputLogs
    ...
    {
        CreateStockInputLogWindow window = new() { Owner = Window.GetWindow(this) };
    ...
    private void RefreshDataGrid()
    {
        Dispatcher.BeginInvoke(
            ...
            new Action(() =>
            {
                StockInputLogsDataGrid.ItemsSource = GetData();
            })
        );
    }

    private List<StockInputLog> GetData()
    {
        ...
        return dbContext.StockInputLogs
            .Where(
                x =>
                    (
    ...
    private void ExportButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        Dispatcher.BeginInvoke(
            ...
            new Action(() =>
            {
                ...
                var now =
                    (Month)MonthCB.SelectedItem == Month.Semua
                        ? DateTime.Now.ToString("yyyy")
                        : DateTime.Now.ToString("MMMM yyyy", idCi);
                var name = $"Laporan Barang Masuk ({now}).pdf";

                var savePath = Path.Combine(outputDir, name);

                var data = GetData();
                var pdf = new StockInputLogExporter(data);
