...
internal class StockInputLogExporter : PdfExporter
{
    protected override string[] HeaderLines { get; } = new[] { "Riwayat Barang Masuk" };
    ...
    private readonly List<StockInputLog> _data;

    public StockInputLogExporter(List<StockInputLog> data)
    {
        _data = data;
    }
